...
import { FoldersComponent } from './navigation/folders/folders.component';
...
@NgModule({
  ...
  entryComponents: [NavbarComponent, CategoryModalComponent, EditCategoryModalComponent, FoldersComponent]
})
